...
<head>
    ...
    <title>Pedidos | De Castilla</title>
...
<body class="body">
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            <div class="verPedido">
                <div class="verPedido__cabecera verVenta__cabecera">
                        <h1>Venta #1000</h1>
                        <p>Administrador</p>
                </div>
                <div class="verPedido__Cuerpo">
                    ...
                    <div class="carrito__producto">
                        <img src="{{asset("assets/img/galeria 3.png")}}" alt="" disabled>
                        <div class="producto__descripcion">
                            <h5>Producto</h5>
                            <p>$5000</p>
                        </div>
                ...
                <div class="verPedido__footer">
                    ...
                    <div class="botones">
                        <a href="./editarVenta" class="btn btn-aceptarCambios">Editar venta</a>
                    </div>
                </div>
            </div>
        </div>
