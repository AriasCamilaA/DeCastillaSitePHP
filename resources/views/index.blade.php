...
<body>
    <nav class="landingMenu">
        <div class="landingMenu__links">
            <img class="logo" src="{{asset("assets/img/logoClaro.png")}}" alt="logo De Castilla">
            <ul>
        ...
        <div class="landingMenu__btns">
            <a href="./usuarios/login" class="btn">Iniciar Sesión</a>
            <a href="./usuarios/register" class="btn">Registrarse</a>
        </div>
    </nav>
    <section id="banner">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="carrusel">
                        ...
                        <img src="./assets/img/p2.jpeg" class="d-block w-100">
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="carrusel">
                        ...
                        <img src="./assets/img/p3.jpeg" class="d-block w-100">
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="carrusel">
                        ...
                        <img src="./assets/img/p4.jpeg" class="d-block w-100">
                    </div>
                </div>
            </div>
    ...
    <section id="quienes_somos" class="quienes_somos container ">
        <img src="./assets/img/separador.png")}}" alt="" class="separador">
        <h1>Quíenes somos</h1>
